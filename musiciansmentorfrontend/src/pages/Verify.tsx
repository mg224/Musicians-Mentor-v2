      ...
      <div className="max-w-md w-full space-y-8 z-10">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center items-center space-x-3 mb-4">
            <div className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-green-400 to-blue-500 rounded-full mb-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`block w-full pl-10 pr-3 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-lg font-mono tracking-widest ${
        ...
        <div className="text-center">
          <Link
            to="/"
            type="button"
            className="inline-flex items-center space-x-2 text-gray-600 hover:text-purple-600 transition-colors duration-200 cursor-pointer"
          >
